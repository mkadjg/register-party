...
<html class="has-navbar-fixed-top">
    ...
    <body>
        ...
        <div class="columns offtop">
            <div class="column is-6">
                <form class="box">
                    <h3 class="subtitle is-3">Update Profile</h3>
                    <div class="field" hidden="true">
                        <label class="label">Id Anggota</label>
                        <div class="control">
                            <input class="input" name="idAnggota" type="text" placeholder="Id Anggota" hidden="true">
                        </div>
                    </div>
                ...
                <form class="box">
                    ...
                    <div class="field">
                        <label class="checkbox">
                            <input type="checkbox" name="pernyataan" id="pernyataan" checked disabled>
                    ...
                    <button type="submit" id="submit" class="button is-warning"><strong>Update</strong></button>
                </form>
            </div>
        </div>
    ...
    <script src="${contextPath}/js/updateprofileanggota.js"></script>
    </body>
</html>